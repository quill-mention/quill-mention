...
| `mentionsContainment`                         | `'window'`                                            | Options are `'window'` and `'quill'`. When set to `'quill'`, the mentions menu will be rendered constrained within the bounds of the quill container. Otherwise, it will be of the browser window.                                                                                                                                                                                                                                                                                  |
