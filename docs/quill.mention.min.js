var quillMention = (function (t) {
	...
	var O = (function (t) {
		...
		function n(t, i) {
			...
			return (
				r(this, n),
				h(f((o = e.call(this, t, i))), 'hoverHandler', void 0),
				h(f(o), 'hoverHandler', void 0),
				(o.clickHandler = null),
				(o.hoverHandler = null),
				(o.mounted = !1),
				o
				...
				[
					{
						key: 'attach',
						value: function () {
							p(c(n.prototype), 'attach', this).call(this),
								this.mounted ||
									((this.mounted = !0),
									(this.clickHandler =
										this.getClickHandler()),
									(this.hoverHandler =
										this.getHoverHandler()),
					...
					},
					{
						key: 'detach',
						value: function () {
							p(c(n.prototype), 'detach', this).call(this),
								(this.mounted = !1),
								this.clickHandler &&
					...
					},
					{
						...
						value: function (t, e) {
							...
							return (
								(n.value = u({}, this.domNode.dataset)),
								(n.event = e),
								n
							);
						}
				...
				[
					{
						key: 'create',
						value: function (t) {
							var e = p(c(n), 'create', this).call(this),
								i = document.createElement('span');
							return (
								(i.className = 'ql-mention-denotation-char'),
								(i.innerText = t.denotationChar),
								e.appendChild(i),
								'function' == typeof this.render
									? e.appendChild(this.render(t))
									: (e.innerText += t.value),
								n.setDataValues(e, t)
							);
						}
	...
	var L = (function () {
		function t(e, n) {
			...
			e.keyboard.bindings[C].unshift(e.keyboard.bindings[C].pop()),
				e.keyboard.addBinding(
					{ key: x },
					this.escapeHandler.bind(this)
				),
				e.keyboard.addBinding({ key: k }, this.upHandler.bind(this)),
				e.keyboard.addBinding({ key: I }, this.downHandler.bind(this));
		}
		return (
			l(t, [
				{
				...
				},
				{
					...
					value: function () {
						return (
							!this.isOpen ||
							(this.existingSourceExecutionToken &&
								(this.existingSourceExecutionToken.abandoned =
									!0),
				...
				},
				{
					...
					value: function () {
						'fixed' === this.options.positioningStrategy
							...
							: this.quill.container.appendChild(
				...
				},
				{
					...
					value: function () {
						this.options.onBeforeClose(),
							...
							this.setIsOpen(!1),
							this.quill.root.removeAttribute(
				...
				},
				{
					...
					value: function () {
						for (
							...
							this.mentionList.childNodes[e].classList.remove(
								'selected'
							);
						if (
							-1 !== this.itemIndex &&
				...
				},
				{
					...
					value: function (t, e) {
						...
						if (null !== s) {
							var r,
								a = o(o({}, this.options), i);
							a.showDenotationChar || (s.denotationChar = ''),
								e
									? (r = this.cursorPos)
									: ((r = this.mentionCharPos),
						...
						if (this.options.renderLoading())
							if (
								...
								(t.className = 'ql-mention-loading'),
									w(t, this.options.renderLoading()),
							...
							for (var i = -1, o = 0; o < e.length; o += 1) {
								...
								(s.id = 'quill-mention-item-' + o),
									...
									e[o].disabled
										...
										: -1 === i && (i = o),
									(s.dataset.index = o),
									w(s, this.options.renderItem(e[o], n)),
									e[o].disabled
										? (s.onmouseenter =
												this.onDisabledItemMouseEnter.bind(
													this
												))
										: ((s.onmouseenter =
												this.onItemMouseEnter.bind(
													this
												)),
										  (s.onmouseup =
												this.onItemClick.bind(this)),
										  (s.onmousedown =
												this.onItemMouseDown.bind(
													this
												))),
									(s.dataset.denotationChar = t),
									this.mentionList.appendChild(
										E(s, e[o], this.options.dataAttributes)
									);
							}
							(this.itemIndex = i),
								this.highlightItem(),
				...
				},
				{
					...
					value: function () {
						...
						do {
							e++,
								(t = (this.itemIndex + e) % this.values.length);
							var n =
								'true' ===
				...
				},
				{
					...
					value: function () {
						...
						if ('top' === this.options.defaultMenuOrientation) {
							...
							this.options.fixMentionsToQuill || (l += n.top),
								(o = l - i);
						}
						o >= 0
							? this.options.mentionContainerClass
							...
							(this.mentionContainer.style.top = ''.concat(
								o,
								'px'
							)),
							(this.mentionContainer.style.left = ''.concat(
								s,
								'px'
							)),
							(this.mentionContainer.style.visibility =
								'visible');
					}
				},
				{
					...
					value: function () {
						...
						if (null != e) {
							...
							var n,
								...
								l = a ? this.quill.getText(a - 1, a) : '',
								h =
									((n = r),
									(i = this.options.mentionDenotationChars),
									(o = this.options.isolateCharacter),
									(s = this.options.allowInlineMentionChar),
									i.reduce(
										function (t, e) {
											var i;
											if (o && s) {
							...
							if (
								(function (t, e, n, i) {
									...
									var o = t ? e[t - 1] : i;
									return !o || !!o.match(/\s/);
								})(c, r, this.options.isolateCharacter, l)
							) {
								var d = this.cursorPos - (r.length - c);
								this.mentionCharPos = d;
								var f = r.substring(c + u.length);
								if (
									f.length >= this.options.minChars &&
									(function (t, e) {
										return e.test(t);
									})(f, this.getAllowedCharsRegex(u))
								) {
									this.existingSourceExecutionToken &&
										(this.existingSourceExecutionToken.abandoned =
											!0),
									...
									(this.existingSourceExecutionToken = m),
										this.options.source(
											...
											function (e, n) {
												m.abandoned ||
													((t.existingSourceExecutionToken =
														null),
													t.renderList(u, e, n));
											},
											u
	...
	return n.default.register('modules/mention', L), L;
})(Quill);
