...
class Mention {
  ...
  selectItem() {
    ...
    console.log("inserting selected item")
  ...
  insertItem(data) {
    ...
    const pos = this.mentionCharPos
    // console.log(this.mentionCharPos, this.cursorPos, this.mentionCharPos, Quill.sources.USER)
    this.quill
      .deleteText(this.mentionCharPos, this.cursorPos - this.mentionCharPos, Quill.sources.USER);
    // console.log(render)
    // console.log(this.mentionCharPos, this.cursorPos, this.mentionCharPos, Quill.sources.USER, pos)
    this.quill.insertEmbed(pos, 'mention', render, Quill.sources.USER);
    this.quill.insertText(pos + 1, ' ', Quill.sources.USER);
    this.quill.setSelection(pos + 2, Quill.sources.USER);
    this.hideMentionList();
  }
